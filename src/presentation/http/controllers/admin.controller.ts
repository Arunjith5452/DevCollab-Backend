...
import { DashboardStatsDTO } from "@/application/dtos/admin/dashboard-stats.dto";
...
export class AdminController {
    constructor(
        ...
        @inject(ADMIN_TYPES.GetAdminDashboardStatsUseCase) private readonly _getDashboardStatsUseCase: IExecute<{ startDate?: Date, endDate?: Date } | void, { message: string, stats: DashboardStatsDTO }>,
        @inject(ADMIN_TYPES.GetAdminActivitiesUseCase) private readonly _getActivitiesUseCase: IExecute<{ page: number, limit: number }, { activities: ActivityItemDTO[], total: number }>,
