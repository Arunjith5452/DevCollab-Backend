...
export class CheckUserBlockStatusUseCase implements IExecute<string,{id:string,email:string,username:string,status:string}>{
    private  _userMapper;
    ...
    async execute(userId : string): Promise<{id:string,email:string,username:string,status:string}> {
